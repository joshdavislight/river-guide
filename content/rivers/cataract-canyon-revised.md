---
# Basic Info
name: "Cataract Canyon | Colorado River"
...
permit:
  required: true
  system: "Self-issue"
  agency: "NPS (Canyonlands)"
  url: "https://www.recreation.gov/permits/621747"
  lotteryWindow:
    open: ""
    close: ""
  resultsDate: ""
...
rapids:
  - mile: 52.0
    name: "Brown Betty"
    class: "III"
    description: "Good warm-up for what's ahead."
  - mile: 58.0
    name: "Mile Long"
    class: "III"
    description: "Long stretch of waves."
  - mile: 62.0
    name: "Big Drop 1"
    class: "IV"
    description: "First of the series. Scout right."
  - mile: 62.5
    name: "Big Drop 2"
    class: "IV+"
    description: "The crux. Large holes. Scout right."
  - mile: 63.0
    name: "Big Drop 3"
    class: "IV+"
    description: "Satan's Gut. Massive at high water."

# Best Camps
camps:
  - name: "Spanish Bottom"
    mile: 59.0
    features: ["large camp", "before big drops"]
    notes: "Scout Big Drops from here"
  - name: "Lathrop"
    mile: 30.0
    features: ["beach"]
  - name: "Lower Red Lake"
    mile: 45.0
    features: ["canyon views"]

# Shuttle Services
shuttles:
  - name: "Tex's Riverways"
    location: "Moab, UT"
    phone: "(435) 259-5101"
  - name: "Tag-A-Long"
    location: "Moab, UT"
...
dangers:
  - type: "big-drops"
    description: "Big Drops 1-3 are serious at high water (30,000+ cfs). Class IV-V territory. Scout from Spanish Bottom."
  - type: "lake-powell"
    description: "Lake Powell flatwater at end. Requires motorized boat or jet boat assist."
  - type: "logistics"
    description: "Takeout logistics complex - coordinate jet boat pickup in advance."
