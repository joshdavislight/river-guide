...
gauges:
  - id: "13317000"
    name: "Salmon River at White Bird"
    primary: true
...
rapids:
  - mile: 8.0
    name: "Slide Rapid"
    class: "IV"
    description: "⚠️ SCOUT REQUIRED. Unrunnable above 18,000 cfs. Wait for levels to drop if necessary."
  - mile: 20.0
    name: "China"
    class: "III+"
...
camps:
  ...
  - name: "Blue Canyon"
    mile: 30.0
    features: ["large camp"]
  - name: "Numerous Beaches"
    mile: 0
    features: ["first-come"]
    notes: "Many excellent camps throughout"

# Shuttle Services
shuttles:
  - name: "Beamers Hells Canyon Tours"
...
dangers:
  - type: "slide-rapid"
    description: "Slide Rapid is unrunnable above 18,000 cfs. Scout required. Wait for levels to drop if too high."
  - type: "big-water"
    description: "High volume river. Bigger than Main or Middle Fork."
